    ...
    <div className="min-h-screen ">
      ...
      <section className="relative py-24 md:py-32 overflow-hidden rounded-4xl">
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          <motion.p
            className="text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto mb-12 leading-relaxed dark:text-white"
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              <div>
                <h2 className="text-4xl font-bold mb-2 bg-linear-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent dark:text-white">
                  Let's Talk
                </h2>
      ...
      <section className="py-16 bg-linear-to-r from-emerald-500/10 to-teal-500/10 rounded-4xl mb-12 ">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <h3 className="text-3xl font-bold text-slate-900 mb-6 dark:text-white">
              Working Hours
            </h3>
