...
const ApprovedApplications = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const { data } = await axiosSecure(`/approved-applications`);
      return data;
    },
  });

  useEffect(() => {
    document.title = "APPROVED APPLICATIONS | ARTHI";
  }, []);
    ...
    <>
      <div className="p-4 sm:p-6 lg:p-10 max-w-full mx-auto min-h-screen">
        <div>
          ...
          >
            <span className="text-emerald-600">Approved</span> Applications
          </h1>
        </div>
